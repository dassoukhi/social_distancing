#1- object detection
#2- object tracking
#3- distance measurement between objects


#1- yolo for object detection(person, dog, horse)
#other techniques for object detection(mobilenet,ssd,rnn)

#yolo can detect over 9000classes
#we use coco dataset on api level

#2- object tracking
#assign an id to every detected person
#draw bounding boxes on it
#draw centroids of the boxes

#exemple: imagine we have a videoframe, which detected 2 person
#we calculate euclid distance from the centroids of each bounding boxes

#p = pixel
#d = distance
#w = largeur de l'object
